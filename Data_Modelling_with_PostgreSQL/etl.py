...
def process_song_file(cur, filepath):
    '''
        This function reads a json file by its filepath, and execute insert data into a table.
    ...
    # Iterating each line in pandas dataframe and inserting the song and artist data
